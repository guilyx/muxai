...
func classifyError(err error) error {
	...
	case strings.Contains(msg, "unauthorized"), strings.Contains(msg, "auth"):
		return muxai.WrapError(muxai.ErrorCodeAuth, muxai.ProviderVibe, "Run", err, false)
	case strings.Contains(msg, "rate limit"), strings.Contains(msg, "too many requests"):
		return muxai.WrapError(muxai.ErrorCodeRateLimit, muxai.ProviderVibe, "Run", err, true)
	case strings.Contains(msg, "timeout"):
		return muxai.WrapError(muxai.ErrorCodeTimeout, muxai.ProviderVibe, "Run", err, true)
	default:
		return muxai.WrapError(muxai.ErrorCodeProviderExec, muxai.ProviderVibe, "Run", err, true)
	}
}
